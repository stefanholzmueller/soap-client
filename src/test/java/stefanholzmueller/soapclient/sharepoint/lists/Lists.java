 ...
 * 
 */
@WebServiceClient(name = "Lists", targetNamespace = "http://schemas.microsoft.com/sharepoint/soap/", wsdlLocation = "file:/C:/code/workspace-pp2/soap-client/src/test/java/stefanholzmueller/soapclient/sharepoint/lists/Lists.asmx.xml")
public class Lists
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/code/workspace-pp2/soap-client/src/test/java/stefanholzmueller/soapclient/sharepoint/lists/Lists.asmx.xml");
