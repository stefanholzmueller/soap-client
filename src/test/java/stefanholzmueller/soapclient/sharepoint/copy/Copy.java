 ...
 * 
 */
@WebServiceClient(name = "Copy", targetNamespace = "http://schemas.microsoft.com/sharepoint/soap/", wsdlLocation = "file:/C:/Users/bear/Desktop/copy.asmx.xml")
public class Copy
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Users/bear/Desktop/copy.asmx.xml");
